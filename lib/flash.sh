...
# NOTE: The monolithic flash_write() has been replaced by the flash pipeline.
# See lib/pipelines/pipeline_flash.sh for the phase functions:
#   _phase_flash_validate  — input validation and size collection
#   _phase_flash_write     — unmount, dd, sync, verify
#   _phase_flash_finalize  — GPT fixup, partition discovery, mount home
